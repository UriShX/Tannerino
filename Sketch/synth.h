...
volatile unsigned char AMP[4] = {
  221, 255, 255, 255};           //-Wave amplitudes [0-255]
...
volatile unsigned int envs[5];                                  //-Envelopte selector [address of envelope in memory]
volatile unsigned int EPCW[5] = {
  0x8000, 0x8000, 0x8000, 0x8000, 0x8000}; //-Envelope phase accumolator
volatile unsigned int EFTW[5] = {
  10, 10, 10, 10, 10};               //-Envelope speed tuning word
